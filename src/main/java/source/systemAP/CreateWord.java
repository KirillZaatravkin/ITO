...
import source.systemAP.model.ApOVDStat;
import source.systemAP.model.*;
...
public class CreateWord {
    ...
    public void WordFindFace(List<ApOVD> apOVDs, List<ApGIBDD> apGIBDDs, List<ApPrist> apPrists, String lastname, String firstname, String middlename, String birthday) {
        ...
        for (  int i = 0; i < apOVDs.size(); i++) {
            ...
            tableRow.getCell(4).setText(String.valueOf(apOVDs.get(i).getDatePost()));
            tableRow.getCell(5).setText(String.valueOf(apOVDs.get(i).getDateZak()));
            tableRow.getCell(6).setText(apOVDs.get(i).getNakaz());
            tableRow.getCell(7).setText(apOVDs.get(i).getProtocolN());
    ...
    public void Resediv (List<ArticleStat> articleStat,List<ApOVDStat> apOVDs, List<ApGIBDDStat> apGIBDDs, List<ApPristStat> apPrists, int kolNar, int kolFace, int kolRes) {
        ...
        tableRowOne.addNewTableCell().setText("Место жительства");
        ...
        for (int i = 0; i < apOVDs.size(); i++) {
            ...
            tableRow.getCell(5).setText(String.valueOf(apOVDs.get(i).getFacktAddr()));
        ...
        for (int i = 0; i < articleStat.size(); i++) {
            ...
            tableRow.getCell(5).setText(articleStat.get(i).getFacktAddr());
            tableRow.getCell(6).setText(String.valueOf(articleStat.get(i).getDateP()));
            tableRow.getCell(7).setText(String.valueOf(articleStat.get(i).getKol()));
            tableRow.getCell(8).setText(" ");
        }
        ...
        for (int i = 0; i < apGIBDDs.size(); i++) {
            ...
            tableRow.getCell(5).setText(apGIBDDs.get(i).getFacktAddr());
            tableRow.getCell(6).setText(String.valueOf(apGIBDDs.get(i).getDateP()));
            tableRow.getCell(7).setText(String.valueOf(apGIBDDs.get(i).getKol()));
            tableRow.getCell(8).setText(s);
        }
        ...
        for (int i = 0; i < apPrists.size(); i++) {
            ...
            tableRow.getCell(5).setText(apPrists.get(i).getFacktAddr());
            tableRow.getCell(6).setText(String.valueOf(apPrists.get(i).getDateP()));
            tableRow.getCell(7).setText(String.valueOf(apPrists.get(i).getKol()));
            tableRow.getCell(8).setText(s);
        }

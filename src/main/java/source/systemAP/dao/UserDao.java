...
public class UserDao {
    ...
    public void addUser(User user) {
        ...
        try {
            ps = connection.prepareStatement("insert into users(username,password,fio,groups) values (?,?,?,?)");
    ...
    public void updateUser(User user) {
        ...
        try {
            ps = connection.prepareStatement("update  users set password=?, fio=?, username=?,groups=? where id=?");
